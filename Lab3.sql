...
select  e1.first_name as 'Jane Doe supervisor' from Employees e1,Employees e2 where e1.id = e2.Supervisor_id and e2.first_name like 'Jane' and e2.last_name like 'Doe';

-- h) Find the number of projects led by John Doe(5pts)
select count(*) as '# of projects led by John Doe' from Employees inner join Projects on Leader_id = Employees.id 
and Employees.first_name = 'John' and Employees.last_name ='Doe'; 
